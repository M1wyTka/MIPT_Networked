...
{
    entities_.resize(max_entity_amt);
    entities_.reserve(max_entity_amt*2);
...
void AgarGame::SetPlayerInputs(const std::string& player_u_id, Vec2 input)
{
...
void AgarGame::KillPlayer(const std::string& player_u_id)
{
